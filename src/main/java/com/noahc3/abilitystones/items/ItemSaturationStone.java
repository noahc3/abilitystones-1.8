...
public class ItemSaturationStone extends Item {
	
	public ItemSaturationStone(String unlocalizedName){
		super();
	...
	*/
	...
	public ItemStack onItemRightClick(ItemStack stack, World worldIn, EntityPlayer playerIn)
    {
		...
		{
			stack.setStackDisplayName(EnumChatFormatting.AQUA + "Saturation Stone");
	...
	public void onUpdate(ItemStack stack, World world, Entity entity, int metadata, boolean bool)
	{
	        ...
	        if (stack.getTagCompound().getInteger("Enabled") == 1)
	        {
	        	...
	        	int checkValue = stack.getTagCompound().getInteger("Timer") % 20;
