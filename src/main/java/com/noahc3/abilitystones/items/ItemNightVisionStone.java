...
public class ItemNightVisionStone extends Item {
	
	public ItemNightVisionStone(String unlocalizedName){
		super();
	...
	*/
	...
	public ItemStack onItemRightClick(ItemStack stack, World worldIn, EntityPlayer playerIn)
    {
		...
		{
			stack.setStackDisplayName(EnumChatFormatting.AQUA + "Night Vision Stone");
	...
	public void onUpdate(ItemStack stack, World world, Entity entity, int metadata, boolean bool)
	{
	        ...
	        if (stack.getTagCompound().getInteger("Enabled") == 1)
	        {
	        	...
	        	((EntityLivingBase) entity).addPotionEffect(new PotionEffect(Potion.nightVision.id, 60, 2));
