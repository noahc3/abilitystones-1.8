...
public class ItemRegenerationStone extends Item {
	...
	public ItemRegenerationStone(String unlocalizedName){
		super();
	...
	*/
	...
	public ItemStack onItemRightClick(ItemStack stack, World worldIn, EntityPlayer playerIn)
    {
		...
		{
			stack.setStackDisplayName(EnumChatFormatting.AQUA + "Regeneration Stone");
	...
	public void onUpdate(ItemStack stack, World world, Entity entity, int metadata, boolean bool)
	{
	        ...
	        if (stack.getTagCompound().getInteger("Enabled") == 1)
	        {
	        	...
	        	((EntityLivingBase) entity).addPotionEffect(new PotionEffect(Potion.regeneration.id, 60, 2));
